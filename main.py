...
<p style="font-size:15px;line-height:1.8;color:#1e293b;margin:0 0 24px;">[이 글로 해결할 수 있다는 연결 문장]</p>
...
<p style="font-size:13px;color:#475569;line-height:1.7;margin:0 0 16px;">[짧고 쉬운 설명 1~2문장]</p>
